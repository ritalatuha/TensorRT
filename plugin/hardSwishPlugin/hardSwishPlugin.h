...
#ifndef TRT_HARDSWISH_PLUGIN_H
#define TRT_HARDSWISH_PLUGIN_H
...
class HardSwishPlugin : public IPluginV2Ext
{
public:
    HardSwishPlugin();

    HardSwishPlugin(DataType iType, int iC, int iH, int iW);
...
class HardSwishPluginCreator : public BaseCreator
{
public:
